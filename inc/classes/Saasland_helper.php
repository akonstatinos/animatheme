    ...
    public function logo() {
        ...
        <a class="navbar-brand sticky_logo <?php echo esc_attr($split_logo) ?>" href="<?php echo esc_url(home_url( '/')) ?>">
            ...
            if (isset($opt['main_logo']['url'])) {
                ...
                ?>
                <img src="<?php echo esc_url($main_logo); ?>" data-test="1" <?php echo wp_kses_post($logo_srcset) ?> alt="<?php bloginfo( 'name' ); ?>">
                <img src="<?php echo esc_url($sticky_logo); ?>" data-test="2" <?php echo wp_kses_post($logo_srcset_sticky) ?> alt="<?php bloginfo( 'name' ); ?>">
                <?php
            } else {
